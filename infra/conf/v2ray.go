...
type Config struct {
	...
	SSPanel         *SSPanelConfig         `json:"sspanel"`
}
...
func (c *Config) Build() (*core.Config, error) {
	...
	statsConfig := c.Stats
	if statsConfig == nil && c.SSPanel != nil {
		statsConfig = &StatsConfig{}
	}
	if statsConfig != nil {
		statsConf, err := statsConfig.Build()
		if err != nil {
			return nil, err
		}
	...
	policyConfig := c.Policy
	if policyConfig == nil && c.SSPanel != nil {
	...
	if c.SSPanel != nil {
		sspanelConfig, err := c.SSPanel.Build()
		if err != nil {
			return nil, err
		}
		config.App = append(config.App, serial.ToTypedMessage(sspanelConfig))
	}
